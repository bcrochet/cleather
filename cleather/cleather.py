...
class CLeather:
    def __init__(self):
        ...
        try:
            ...
            print("{} is not currently a valid data source." % DATASOURCE)
    ...
    def main(self):
        ...
        print(P_ICON + " " + MY_TIME, WHEREAMI, "-", SUMMARY + ",", str(TEMPERATURE) +
              I_DEG)
